...
To build the final jar and optimize the unilakmet application for production, run:
...
Then navigate to [http://localhost:40224](http://localhost:40224) in your browser.
