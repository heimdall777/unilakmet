...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './material.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MATERIAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_MATERIAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MATERIAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MATERIAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MATERIAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MATERIAL actions', async () => {
      const expectedActions = [
        {
