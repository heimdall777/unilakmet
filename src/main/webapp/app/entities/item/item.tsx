  ...
  return (
    <div>
      <h2 id="item-heading" data-cy="ItemHeading">
        <Translate contentKey="unilakmetApp.item.home.title">Items</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="unilakmetApp.item.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/item/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="unilakmetApp.item.home.createLabel">Create new Item</Translate>
          </Link>
        </div>
      </h2>
        ...
        {itemList && itemList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="unilakmetApp.item.home.notFound">No Items found</Translate>
            </div>
          )
        )}
      </div>
